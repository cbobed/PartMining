...
+ The [datasets folder](https://github.com/cbobed/PartMining/tree/main/datasets) contains the .dat files of the non-synthetic datasets used in the experiments (corresponding to CBDs). LDBs datasets can be found here (github did not allowed us to host >100MB files): [DBpedia36](http://sid.cps.unizar.es/projects/dataEvolution/dbpedia36PCB.tar.gz), [DBpedia2014](http://sid.cps.unizar.es/projects/dataEvolution/dbpedia2014PCB.tar.gz), [DBpedia2016-10](http://sid.cps.unizar.es/projects/dataEvolution/dbpedia201610PCB.tar.gz), and [Kosarak](http://sid.cps.unizar.es/projects/dataEvolution/kosarak.tar.gz). The synthetic ones (SDBs) were built following *Guidoti et al., Clustering Individual Transactional Data for Masses of Users (SIGKDD'17)*, using their code available at [tx-means repository](https://github.com/riccotti/TX-Means).
