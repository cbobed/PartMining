...
BATCH_NUMBER = 20
BATCH_DIR = os.path.join('.', 'statisticalRelevance', 'completeResults')
...
if __name__ == "__main__":
    ...
    for dataset in DATASET_NAMES:
        ...
        invalid_batches = sum([1 for i in range(1,21) if Headers.INVALID_BATCH in gathered_data[dataset][i]])
